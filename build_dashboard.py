...
def label(text: str, width: int = 18) -> str:
    """Left-align label text to a fixed width so values form a column."""
    return f"{text:<{width}}"


def value(text: str, indent: int = 18) -> str:
    """Indent-only line (used for multi-line sections like Recent form)."""
    return " " * indent + text
